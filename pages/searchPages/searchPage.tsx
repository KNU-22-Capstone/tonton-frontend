...
function searchPage() {
  ...
  const fetchdata = async () => {
    const url = "http://210.125.212.192:8666/api/clothes?size=100&page=0&detailTag=셔츠";
    await axios
      .get(url)
      .then((response) => {
  ...
  const tagButtononClickHandler = async (tag:string) => {
    //setProduct(null);
    setsiteTag(tag); 
    fetchData_Site(siteTag);
  }
          ...
          <div className="absolute bottom-0 right-0">
            ...
            <div className="inline-block ">
              <img
                ...
                onClick={()=>tagButtononClickHandler('musinsa')}
              />
            </div>
            <div className="inline-block">
              <img
                ...
                onClick={()=>tagButtononClickHandler('lookpin')}
              />
            </div>
            <div className="inline-block">
              <img
                ...
                onClick={()=>tagButtononClickHandler('hiver')}
              />
            </div>
            <div className="inline-block">
              <img
                ...
                onClick={()=>tagButtononClickHandler('29cm')}
              />
            </div>
          </div>
        </div>
